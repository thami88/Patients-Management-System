	...
	public String readPatients() {
		...
		try {
			...
			while (rs.next()) {
				...
				output += "<td><input name='btnUpdate' type='button' value='Update' class='btnUpdate btn btn-warning btn-sm'></td><td><input name='btnRemove' type='button' value='Remove' class='btnRemove btn btn-danger btn-sm' data-pid='" + pID + "'>" + "</td></tr>"; 
